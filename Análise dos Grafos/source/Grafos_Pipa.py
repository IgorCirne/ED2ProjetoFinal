...
B = ox.graph_from_place("Tibau do Sul, Brazil", network_type="drive")
G = ox.graph_from_place("Tibau do Sul, Brazil", network_type="bike")
...
print(f"Número de nós em Tibau do Sul: {num_nodes}")

# Número de arestas
num_edges = len(G.edges)
print(f"Número de ruas em Tibau do Sul: {num_edges}")

# Densidade da rede
density = nx.density(G)
print(f"Densidade da rede de estradas de Tibau do Sul: {density}")

# Comprimento total das arestas

total_edge_length = sum(nx.get_edge_attributes(G, "length").values())
print(f"Comprimento total das ruas em Tibau do Sul: {total_edge_length} metros")
